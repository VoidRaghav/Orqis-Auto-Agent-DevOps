...
const PHASES = [
  {
    num: "01",
    lines:     ["STOP", "FLYING", "BLIND."],
    color:     "#ffffff",
    accent:    "#ffffff",
    sub:       "your agents are black boxes — zero visibility into what's happening",
    bg:        "#000000",
    ghostWord: "BLIND",
    accentLine: -1,
    widget: {
      ...
      rows: [
        { label: "runtime logs",  val: "[REDACTED]", bad: true  },
        { label: "trace context", val: "NONE",        bad: true  },
        { label: "last error",    val: "unknown",     bad: true  },
        { label: "visibility",    val: "◼ ◼ ◼ ◼",     bad: true  },
      ],
    },
  },
  {
    num: "02",
    lines:     ["YOUR AGENTS", "ARE BURNING"],
    color:     "#ffaa00",
    accent:    "#ffaa00",
    sub:       "every unchecked loop drains your credits in real time",
    bg:        "#060300",
    ghostWord: "BURN",
    accentLine: -1,
    widget: {
  ...
  },
  {
    ...
    color:     "#ff3333",
    accent:    "#ff3333",
    sub:       "4 seconds · 23 api calls · no base case · recursive loop",
    bg:        "#0a0000",
    ghostWord: "CASH",
    accentLine: -1,
    widget: {
      title: "RUN #4421 BREAKDOWN",
      rows: [
        { label: "duration",   val: "4.2s",   bad: true  },
        { label: "tokens",     val: "8,441",  bad: false },
        { label: "api calls",  val: "23",     bad: false },
  ...
  },
  {
    ...
    color:     "#ffffff",
    accent:    "#00ff88",
    sub:       "mission control for vibe-built agents — zero config, self-healing",
    bg:        "#000a04",
    ghostWord: "ORQIS",
    accentLine: 1,
    widget: {
      ...
      rows: [
        ...
        { label: "diagnose",  val: "auto",       bad: false },
        { label: "patch",     val: "14 sec",     bad: false },
